...
WebUI.check(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Medicaid'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Appointment 1')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_31012023'), '31/01/2023')

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Appointment 1'), 'Appointment 1')
